...
class CrearSugerencia extends Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <Container className="my-5">
          <Row>
            <Container style={{ display: "inline-flex" }}>
              <Link
                className="link"
                to={{ pathname: "/SalaJuego", state: { idJuego: this.state.id_juego } }}
              ...
              <Col xs="6" className="text-start">
                <h3>Nueva sugerencia de pregunta</h3>
              </Col>
            </Container>
          </Row>
          ...
          <Form>
            ...
            <Row className="text-center">
              <Col className="mt-3">
                <Link to={{ pathname: "/SalaJuego", state: { idJuego: this.state.id_juego } }}>
